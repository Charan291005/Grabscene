...
INSERT INTO shows (id, event_id, venue_id, start_time, end_time) VALUES ('ssss1111-ssss-1111-ssss-1111ssss1111', 'eeeeaaaa-eeee-aaaa-eeee-aaaaeeeeaaaa', 'aaaa1111-aaaa-1111-aaaa-1111aaaa1111', NOW() + INTERVAL '5 days', NOW() + INTERVAL '5 days 2 hours');
...
INSERT INTO shows (id, event_id, venue_id, start_time, end_time) VALUES ('ssss2222-ssss-2222-ssss-2222ssss2222', 'eeeebbbb-eeee-bbbb-eeee-bbbbeeeebbbb', 'bbbb2222-bbbb-2222-bbbb-2222bbbb2222', NOW() + INTERVAL '2 days', NOW() + INTERVAL '2 days 3 hours');

-- 5. Seed Show Seats
-- Event A: Mixed Availability
INSERT INTO show_seats (id, show_id, seat_id, status, price) VALUES 
(gen_random_uuid(), 'ssss1111-ssss-1111-ssss-1111ssss1111', 'eeee5555-eeee-5555-eeee-5555eeee5551', 'available', 150.00),
(gen_random_uuid(), 'ssss1111-ssss-1111-ssss-1111ssss1111', 'eeee5555-eeee-5555-eeee-5555eeee5552', 'held', 150.00), -- active hold
(gen_random_uuid(), 'ssss1111-ssss-1111-ssss-1111ssss1111', 'eeee5555-eeee-5555-eeee-5555eeee5553', 'booked', 45.00), -- already sold
(gen_random_uuid(), 'ssss1111-ssss-1111-ssss-1111ssss1111', 'eeee5555-eeee-5555-eeee-5555eeee5554', 'available', 45.00);

-- Event B: 100% Sold Out
INSERT INTO show_seats (id, show_id, seat_id, status, held_by, price) VALUES 
('hhhh9999-hhhh-9999-hhhh-9999hhhh9991', 'ssss2222-ssss-2222-ssss-2222ssss2222', '00007777-0000-7777-0000-777700007771', 'booked', '33333333-3333-3333-3333-333333333333', 85.00),
('hhhh9999-hhhh-9999-hhhh-9999hhhh9992', 'ssss2222-ssss-2222-ssss-2222ssss2222', '00007777-0000-7777-0000-777700007772', 'booked', '33333333-3333-3333-3333-333333333333', 85.00);
...
('bbbb9999-bbbb-9999-bbbb-9999bbbb9999', '33333333-3333-3333-3333-333333333333', 'ssss2222-ssss-2222-ssss-2222ssss2222', 'GS-DEMO-TEST', 170.00, 'confirmed');

INSERT INTO booking_items (booking_id, show_seat_id, price) VALUES 
('bbbb9999-bbbb-9999-bbbb-9999bbbb9999', 'hhhh9999-hhhh-9999-hhhh-9999hhhh9991', 85.00),
('bbbb9999-bbbb-9999-bbbb-9999bbbb9999', 'hhhh9999-hhhh-9999-hhhh-9999hhhh9992', 85.00);

-- 6. Populate Waitlist for Event B
-- 4 users waiting in FIFO line
INSERT INTO waitlist (show_id, category, user_id, status, position) VALUES 
('ssss2222-ssss-2222-ssss-2222ssss2222', 'Premium', '44444444-4444-4444-4444-444444444444', 'waiting', 1),
('ssss2222-ssss-2222-ssss-2222ssss2222', 'Premium', '11111111-1111-1111-1111-111111111111', 'waiting', 2),
('ssss2222-ssss-2222-ssss-2222ssss2222', 'Premium', '22222222-2222-2222-2222-222222222222', 'waiting', 3),
('ssss2222-ssss-2222-ssss-2222ssss2222', 'Premium', '33333333-3333-3333-3333-333333333333', 'waiting', 4);
